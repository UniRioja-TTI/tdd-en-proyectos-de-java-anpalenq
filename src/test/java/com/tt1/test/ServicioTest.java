...
public class ServicioTest {
	 ...
	 private DBStub dbStub;
	    ...
	    public void setUp() {
	        ...
	        task2 = new ToDo("Tarea 2", "Descripción 2", new Date(System.currentTimeMillis() - 10000), false); // tarea vencida
	    }
	    ...
	    public void testAddEmail() {
	        ...
	        boolean result = mailerStub.enviarCorreo(email, "Este es un mensaje de prueba");
	    ...
	    public void testMarkTaskAsCompleted() {
	        ...
	        servicio.marcarComoCompletado(1);
	    ...
	    public void testCheckForOverdueTasks() {
	        ...
	        repositorio.almacenarNuevoToDo(task1);  // tarea sin vencerse
	        repositorio.almacenarNuevoToDo(task2);  // tarea vencida
	        ...
	        assertTrue(mailerStub.enviarCorreo("test@example.com", "Alerta: La tarea 'Tarea 2' ha vencido."),
